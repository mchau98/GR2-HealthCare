...
const Posts = () => {
  ...
  return (
    <div className="posts-home">
      ...
      <div className="blog-all-item">
        <div className="title">
          <h2 class="blog-name"> Ăn uống lành mạnh</h2>
          <p class="see-all">
            Xem tất cả <FontAwesomeIcon icon={faChevronRight} />
          </p>
        </div>
        <div className="blog-item">
          <LatestPost category="Ăn uống lành mạnh" />
          <PostsPagination
      ...
      <div className="blog-all-item">
        <div className="title">
          <h2 class="blog-name"> Giảm cân lành mạnh</h2>
          <p class="see-all">
            Xem tất cả <FontAwesomeIcon icon={faChevronRight} />
          </p>
        </div>
        <div className="blog-item">
          <LatestPost category="Giảm cân lành mạnh" />
          <PostsPagination
